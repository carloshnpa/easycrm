                ...
                <div className="px-4 md:px-6 space-y-10 xl:space-y-16">
                    <div className="grid max-w-[1300px] mx-auto gap-4 px-4 sm:px-6 md:px-10 md:grid-cols-2 md:gap-16">
                        ...
                        <div className="flex flex-col items-start space-y-4">
                            ...
                            <h2 className=" text-3xl font-bold tracking-tighter sm:text-5xl">Streamline
                                Your Business
                                Operations</h2>
                            <div
                                className=" inline-block ml-auto mr-[10px] rounded-lg bg-gray-100 px-3 py-1 text-sm dark:bg-gray-800">New
                                Features
                            </div>
